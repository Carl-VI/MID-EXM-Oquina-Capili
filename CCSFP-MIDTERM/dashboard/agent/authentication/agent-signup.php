...
class AgentController
{
    ...
    public function agentRegistration($first_name, $middle_name, $last_name, $email, $valid_id, $hash_password, $tokencode, $user_type, $package_type)
    {
...
if (isset($_POST['btn-register-agent'])) {
    ...
    $register_agent->agentRegistration($first_name, $middle_name, $last_name, $email, $valid_id, $hash_password, $tokencode, $user_type, $package_type);
}
