                    ...
                    <div class="auto-container">
                        ...
                        <div class="pagination-wrapper">
                            <ul id="pagination" class="pagination clearfix">
                                <li><a href="property.php" class="current">1</a></li>
                                <li><a href="property.php">2</a></li>
                                <li><a href="property.php">3</a></li>
                                <li><a href="property.php"><i class="fas fa-angle-right"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </section>
