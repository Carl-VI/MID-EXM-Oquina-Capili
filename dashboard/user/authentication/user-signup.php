...
class UserController
{
    ...
    public function userVerifyOtp($first_name, $middle_name, $last_name, $email, $hash_password, $tokencode, $user_type, $user_status, $otp)
    {
        if ($otp == $_SESSION['OTP']) {
            ...
            $this->user->register($first_name, $middle_name, $last_name, $email, $hash_password, $tokencode, $user_type, $user_status, $otp);
            $id = $this->user->lasdID();
